...
pub fn build(b: *std.Build) !void {
    ...
    _ = b.addModule("libmongoc", .{ .root_source_file = lazyPathFromRoot(b, "lib/libmongoc-static-1.0.a") });
    _ = b.addModule("libbson", .{ .root_source_file = lazyPathFromRoot(b, "lib/libbson-static-1.0.a") });
}
